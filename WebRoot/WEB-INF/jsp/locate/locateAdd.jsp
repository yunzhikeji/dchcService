...
//id为policeroom的id后缀 根据belongplace的值获取
...
<div  class="row cl">
  <div class="col-6 col-offset-6 ">
      <div class="col-2 f-r"><input type="submit"  class="btn btn-success radius" value="确认保存" id="submit"></input></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height:45px;">
  ...
  <tr>
    ...
    <select id="belongplace"  class="input-text radius size-M " name="belongplace" style="width:200px;"> 
   	   <option value="0">请选择所属派出所</option> 
       <option value="1">剪子股派出所</option> 
       <option value="2">黄河涯派出所</option> 
       <option value="3">东地派出所</option> 
       <option value="4">新河东路派出所</option> 
       <option value="5">于官屯派出所</option> 
       <option value="6">建设街派出所</option> 
       <option value="7">车站街派出所</option> 
       <option value="8">湖滨北路派出所</option> 
       <option value="9">二屯派出所</option>
       <option value="10">长庄派出所</option> 
   </select> 
   </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   ...
   <input  type="hidden" name="policeroom" id="policeroom"/>
   </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
