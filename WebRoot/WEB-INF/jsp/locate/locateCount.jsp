...
<div class="pd-20">
  <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="${pageContext.request.contextPath }/locate/count?countType=10" class="btn btn-primary radius">所属派出所统计</a> </span>
  <span class="l" style="margin-left:2px"><a href="${pageContext.request.contextPath }/locate/count?countType=2" class="btn btn-primary radius">是否出租房统计</a> </span>
  <span class="l" style="margin-left:2px"><a href="${pageContext.request.contextPath }/locate/count?countType=6" class="btn btn-primary radius">场所类别统计</a> </span>
