...
var id = "${locate.belongplace}";

var policeroom = "${locate.policeroom}";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height:45px;">
  ...
  <tr>
    ...
    <select id="belongplace"  class="input-text radius size-M " name="belongplace" style="width:200px;"> 
   	   <option value="0" ${locate.belongplace==0?'selected':''}>请选择所属派出所</option> 
       <option value="1" ${locate.belongplace==1?'selected':''}>剪子股派出所</option> 
       <option value="2" ${locate.belongplace==2?'selected':''}>黄河涯派出所</option> 
       <option value="3" ${locate.belongplace==3?'selected':''}>东地派出所</option> 
       <option value="4" ${locate.belongplace==4?'selected':''}>新河东路派出所</option> 
       <option value="5" ${locate.belongplace==5?'selected':''}>于官屯派出所</option> 
       <option value="6" ${locate.belongplace==6?'selected':''}>建设街派出所</option> 
       <option value="7" ${locate.belongplace==7?'selected':''}>车站街派出所</option> 
       <option value="8" ${locate.belongplace==8?'selected':''}>湖滨北路派出所</option> 
       <option value="9" ${locate.belongplace==9?'selected':''}>二屯派出所</option>
       <option value="10"${locate.belongplace==10?'selected':''}>长庄派出所</option> 
   </select> 
   </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
   ...
   <input  type="hidden" name="policeroom" value="${locate.policeroom}" id="policeroom"/>
   </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
