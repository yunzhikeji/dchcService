...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i><span class="c-gray en">&gt;</span>人员信息检测
			...
			<tbody>
				...
				<c:forEach items="${jpushpersonList }" var="jpushperson"
						...
						<tr class="text-c">
							...
							<td class="f-14 td-manage"><textarea id="remark${jpushperson.id}" rows="4"
									style="height: 100%; width: 100%" name=""></textarea></td>
							<td class="f-14 td-manage">
								     <a style="text-decoration:none" class="ml-5" onclick="result(${jpushperson.id},1);" href="javascript:;" title="正确"><i class="Hui-iconfont" style="font-size:30px">&#xe6e1;</i></a> 

									 <a style="text-decoration:none" class="ml-5" onclick="result(${jpushperson.id},2);" href="javascript:;" title="不正确"><i class="Hui-iconfont" style="font-size:30px">&#xe6dd;</i></a>
						</tr>
					</c:forEach>
			</tbody>
		</table>
