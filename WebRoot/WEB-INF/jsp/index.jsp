...
<body>
	<header class="Hui-header cl">
		<a class="Hui-logo l" href="#"></a> <img style="margin-top: 25px"
			src="${pageContext.request.contextPath }/images/logo.png" width="489"
			height="70">
		<ul class="nav" style="margin-right: 20px; margin-top: 25px">
			<li><a
				href="${pageContext.request.contextPath }/login/logout.action"
				title="注销"><img
					src="${pageContext.request.contextPath }/images/icon07.png"
					title="注销" />
				<h4>注销</h4> </a></li>
		</ul>
	...
	<aside class="Hui-aside" style="overflow-y: auto; overflow-x: hidden;">
		<div class="menu_dropdown bk_2">
			<div class="my-profile dropDown dropDown_hover">
				<a href="#" class="my-profile-pic"> <img
					src="${pageContext.request.contextPath }/images/user.jpg" alt="" />
				</a> <span class="first-child">您好 ，<strong>${username}</strong></span> <span>警号：123456</span>
			</div>
					...
					<ul>
						<c:if test="${type==1}">
							<li><a
								...
								target="myiframe">用户管理 </a></li>
						</c:if>
						<li><a
							href="${pageContext.request.contextPath }/jcheck.action"
							target="myiframe">人员信息检测 </a></li>
						<li><a
							href="${pageContext.request.contextPath }/person/list.action"
							target="myiframe">人员信息导出</a></li>
						<li><a
	...
	<section class="Hui-article-box">
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe name="myiframe" scrolling="yes" frameborder="0"
					src="${pageContext.request.contextPath }/jcheck.action"></iframe>
			</div>
		</div>
