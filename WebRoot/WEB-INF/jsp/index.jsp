...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath }/css/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet"
			type="text/css" />
	...
	<body>
		...
		<div class="menu_dropdown bk_2">
			...
			<ul class="ce">
				<li>
					<a href="#"><i class="Hui-iconfont ">&#xe62c;</i> 日常工作 </a>
					<ul class="er" style="display: block;">
						<li class="e_li">
							...
							<ul class="thr">
								<li>
									<a _href="personAction!list?type=1" href="javascript:void(0)">人员信息检测</a>
								</li>
							</ul>
						</li>
						<li class="e_li">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/js/layer/1.9.3/layer.js"></script>
