...
<body>
	...
	<form name="userroleForm"
		action="${pageContext.request.contextPath }/user/add" onsubmit="return checkUserRole();"
					...
					<div class="tabCon">
						<div class="row cl text-c">
							<h1 style="line-height: 80px; margin-bottom: 10px;">
								<small style="color: #000;">新增用户</small>
							</h1>
						</div>
						<div class="row cl">
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="25%"><input name="username" id="username" type="text"
								...
								<tr>
									...
									<td width="25%"><input name="password" id="password" type="text"
										class="input-text radius size-M " style="width: 200px;">
									</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								...
								<tr>
									...
									<td width="25%"><input name="telephone" type="text"
										class="input-text radius size-M " style="width: 200px;">
									</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
								...
								<tr>
									...
									<td width="25%"><input name="realname" type="text"
										class="input-text radius size-M " style="width: 200px;">
									</td>
									<td>&nbsp;</td>
									<td>&nbsp;</td>
